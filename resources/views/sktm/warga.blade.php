...
@section('content')
    ...
    <div class="tab-content mt-3">
        ...
        <div class="tab-pane fade" id="deskripsi">
            ...
            <p>Surat Keterangan Tidak Mampu adalah dokumen resmi yang menerangkan bahwa pemohon berasal dari keluarga kurang mampu. Surat ini sering digunakan untuk keperluan seperti pengajuan beasiswa atau bantuan sosial.</p>            <p><strong>Output:</strong> <span id="output"></span></p>
