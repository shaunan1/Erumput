...
@section('content')
    ...
    @endpush
        ...
        <!-- TABS -->
        <ul class="nav nav-tabs" id="sktmTabs">
            <li class="nav-item">
        ...
        <div class="tab-content mt-3">
            ...
            <div class="tab-pane fade" id="deskripsi">
                <h3 class="fw-bold">PENGAJUAN SURAT KETERANGAN TIDAK MAPU</h3>
                <p>Surat Keterangan Tidak Mampu  adalah surat yang menerangkan belum pernah menikah alias berstatus lajang.</p>
