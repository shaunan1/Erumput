...
@section('content')
    ...
    <div class="tab-content mt-3">
        <div class="tab-pane fade show active" id="status">
            <h3 class="fw-bold">USULAN PENGAJUAN SURAT KETERANGAN </h3>
            <br>
        ...
        <div class="tab-pane fade" id="deskripsi">
            <h3 class="fw-bold">PENGAJUAN SURAT KETERANGAN </h3>
            <p>Surat Keterangan adalah </p>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="formModalLabel">Usulan Pengajuan Surat Keterangan </h5>
            ...
            <div class="modal-body">
                <form id="suratForm">
                    ...
                    <button type="submit" class="btn btn-primary mt-3 flex items-center space-x-2">
                        <img src="{{ asset('images/save changes.png.png') }}" alt="Save Changes" class="w-6 h-6"> 
                    </button>
                </form>
            </div>
        </div>
...
@push('scripts')
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            document.getElementById("output").textContent = "Surat Keterangan ";
