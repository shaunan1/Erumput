...
@section('content')
    ...
    @endpush
        ...
        <!-- TABS -->
        <ul class="nav nav-tabs" id="skhslTabs">
            <li class="nav-item">
        ...
        <div class="tab-content mt-3">
            ...
            <div class="tab-pane fade show active" id="status">
                <h3 class="fw-bold">USULAN PENGAJUAN SURAT KETERANGAN PENGHASILAN</h3>
                <br>
            ...
            <div class="tab-pane fade" id="deskripsi">
                ...
                <p>Surat Keterangan Penghasilan adalah surat yang menerangkan belum pernah menikah alias berstatus lajang.</p>
    ...
    @push('scripts')
        <script>
            document.addEventListener("DOMContentLoaded", function() {
                document.getElementById("output").textContent = "Surat Keterangan Penghasilan ";
