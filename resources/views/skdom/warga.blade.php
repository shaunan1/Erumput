...
@section('content')
    <ul class="nav nav-tabs" id="skdomTabs">
        <li class="nav-item">
    ...
    <div class="tab-content mt-3">
        ...
        <div class="tab-pane fade" id="deskripsi">
            ...
            <p>Surat Keterangan Domisili adalah dokumen yang menerangkan tempat tinggal pemohon. Surat ini sering digunakan untuk administrasi seperti pembuatan rekening bank atau pendaftaran sekolah.</p>            <p><strong>Output:</strong> <span id="output"></span></p>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="formModalLabel">Usulan Pengajuan Surat Keterangan Domisili</h5>
