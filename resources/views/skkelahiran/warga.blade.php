...
@section('content')
    ...
    <div class="tab-content mt-3">
        ...
        <div class="tab-pane fade" id="deskripsi">
            ...
            <p>Surat Keterangan Kelahiran adalah dokumen resmi yang menerangkan kelahiran seorang anak. Surat ini diperlukan untuk pembuatan akta kelahiran atau administrasi lainnya.</p>            <p><strong>Output:</strong> <span id="output"></span></p>
